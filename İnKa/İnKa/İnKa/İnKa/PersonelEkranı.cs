...
namespace İnKa
{
    public partial class PersonelEkranı : Form
    {
      ...
      //  KullanıcıGirişEkranı kullanıcı = new KullanıcıGirişEkranı();
        ...
        private void mesajlari_goster()
        {
            ...
            {
                baglantim.Open();
                OleDbDataAdapter mesajlari_listele = new OleDbDataAdapter("select gonderenadi AS[GONDEREN], aliciadi AS [ALICI],mesaj AS [MESAJ] from mesajlar Order By gonderenadi DESC", baglantim);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                baglantim.Open();
                OleDbCommand eklekomutu = new OleDbCommand("insert into mesajlar values('" + label20.Text + "','" + comboBox4.Text+ "','"+textBox6.Text+"')", baglantim);
